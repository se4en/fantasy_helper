    ...
    admin_keyboard.insert(
        InlineKeyboardButton(
            ...
            callback_data=admin_callback.new(
                tool_name="update_players", league_name="None"
            ),
        )
    )
    admin_keyboard.insert(
        InlineKeyboardButton(
            ...
            callback_data=admin_callback.new(
                tool_name="update_coeffs", league_name="None"
            ),
        )
    )
    admin_keyboard.insert(
        InlineKeyboardButton(
            ...
            callback_data=admin_callback.new(
                tool_name="update_stats", league_name="None"
            ),
        )
    )
    admin_keyboard.insert(
    ...
    for league in coeff_manager.get_leagues():
        leagues_keyboard.insert(
            InlineKeyboardButton(
                ...
                callback_data=admin_callback.new(
                    tool_name=tool_name, league_name=league
                ),
            )
        )
    leagues_keyboard.insert(
        InlineKeyboardButton(
            ...
            callback_data=admin_callback.new(
                tool_name="back_to_list", league_name="None"
            ),
        )
    )
